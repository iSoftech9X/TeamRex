...
// // //   // Refs to hold current state to avoid stale closures in WebSocket callbacks
// // //   const selectedChatRef = useRef(selectedChat);
// // //   useEffect(() => {
// // //     selectedChatRef.current = selectedChat;
// // //   }, [selectedChat]);

// // //   // NEW: Ref to hold the list of all users for the WebSocket handler
...
// // //       // UPDATED: Sound now plays for any incoming message, regardless of the active chat
...
// // //       // UPDATED: Logic to update chat list and sort by most recent message
// // //       setChats(prevChats => {
...
// // //           // Chat doesn't exist and it's an incoming message, so create it
...
// // //         } else {
// // //           // Message is from self to a new person, but `startNewChat` should have already created it.
// // //           // This is a fallback to prevent unexpected behavior.
// // //           return prevChats;
// // //         }

// // //         // Sort the array to bring the chat with the latest message to the top
...
// // //           : chat
// // //       ).sort((a, b) => new Date(b.lastMessageTime) - new Date(a.lastMessageTime))); // Also sort on send
// // //     } catch (error) {
...
// // //             {errors.chats && (<div className="p-3 bg-red-50 text-red-700 flex items-center justify-between"><div className="flex items-center"><AlertCircle size={16} className="mr-2" /><span className="text-sm">{errors.chats}</span></div></div>)}
